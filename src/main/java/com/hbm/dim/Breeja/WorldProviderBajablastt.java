...
import com.hbm.dim.Breeja.genlayer.GenLayerEveBiomes;
import com.hbm.dim.Breeja.genlayer.GenLayerEveRiverMix;
...
public class WorldProviderBajablastt extends WorldProviderCelestial {
	...
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderBajablast(this.worldObj, this.getSeed());
	}
