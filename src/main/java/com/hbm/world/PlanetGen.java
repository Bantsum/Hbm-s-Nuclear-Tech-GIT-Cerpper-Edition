...
import com.hbm.dim.breeja.WorldGeneratorBreeja;
import com.hbm.dim.breeja.WorldProviderBreeja;
...
public class PlanetGen {
	...
	public static void init() {
		...
		registerDimension(SpaceConfig.breejaDimension, WorldProviderBreeja.class);
		...
		GameRegistry.registerWorldGenerator(new WorldGeneratorBreeja(), 1);
	}
